...
### Inital Installation
**Only use this download link for the [latest release](https://github.com/hotbso/AutoDGS/releases/latest) .**

For simbrief integration to work you must install the *[simbrief_hub](https://github.com/hotbso/simbrief_hub/releases/latest)* plugin.
